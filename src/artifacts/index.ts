 ...
 *
 * Both bundled-plugin readers (`../triage` and `../qa`) consume the
 * contract only through here — one copy of the summary parse,
...
export { configuredSlots } from './configured.js';
